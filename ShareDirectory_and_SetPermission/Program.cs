...
namespace ShareDirectory_and_SetPermission
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Share Folder
            ShareFolder(@"D:\Test", "Test13", "TestApplication");
            // Get Working Domain
            ...
            try
            {
                AddPermissions("Test", Domain, "Administrators");
                AddPermissions("Test", Domain, "Everyone");
            }
            catch (Exception e)
            {
        ...
        public static void ShareFolder(string FolderPath, string ShareName, string Description)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Share Folder has been created with the name :" + strShareName);
                }
        ...
        public static void AddPermissions(string sharedFolderName, string domain, string userName)
        {
